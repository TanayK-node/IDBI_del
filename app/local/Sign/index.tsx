      ...
      >
                {signatureImage && fileInfo ? (
                    <div className="text-left w-full">
                        <h3 className="text-gray-700 font-semibold text-base mb-4">Customer's Signature</h3>
                        <div className="flex items-center justify-between w-full">
                            <div className="flex items-center">
                                <img src={signatureImage} alt="Signature" className="w-14 h-14 rounded-lg object-contain bg-gray-100 shadow-sm p-1" />
                                <div className="ml-4">
